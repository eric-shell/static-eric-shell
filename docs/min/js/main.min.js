...
!function(e){e(".resume button").click(function(){e(this).closest(".pane").removeClass("current").next(".pane").addClass("visible").addClass("current"),e("html,body").animate({scrollTop:e(this).closest(".pane").next(".pane").offset().top+100},250)})}(jQuery);