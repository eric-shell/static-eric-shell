...
!function(l){l.expr[":"].onScreen=function(n){var e=l(window),o=e.scrollTop(),t=e.height(),r=o+t,i=l(n),c=i.offset().top+50,f=i.height(),s=c+f;return o<=c&&c<r||o<s&&s<=r||t<f&&c<=o&&r<=s},l(function(){setInterval(function(){l(".on-screen").filter(":onScreen").addClass("visible")},150)})}(jQuery);
