...
!function(e){e.expr[":"].onScreen=function(n){var o=e(window),r=o.scrollTop(),t=o.height(),i=r+t,f=e(n),c=f.offset().top,l=f.height()+200,s=c+l;return c>=r&&c<i||s>r&&s<=i||l>t&&c<=r&&s>=i},e(function(){setInterval(function(){e(".hero, .freelance, .resume, .footer").filter(":onScreen").addClass("visible")},200)})}(jQuery);
!function(e){e(".freelance a").mouseover(function(){e(this).parent().parent().addClass("hover")}),e(".freelance a").mouseout(function(){e(this).parent().parent().removeClass("hover")})}(jQuery);
!function(e){e(".resume button").click(function(){e(this).closest(".pane").removeClass("current").next(".pane").addClass("visible").addClass("current"),e("html,body").animate({scrollTop:e(this).closest(".pane").next(".pane").offset().top+100},350)})}(jQuery);