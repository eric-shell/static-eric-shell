...
!function(c){c.expr[":"].onScreen=function(n){var e=c(window),o=e.scrollTop(),t=e.height(),r=o+t,i=c(n),e=i.offset().top+50,n=i.height(),i=e+n;return o<=e&&e<r||o<i&&i<=r||t<n&&e<=o&&r<=i},c(function(){setInterval(function(){c(".on-screen").filter(":onScreen").addClass("visible")},100)})}(jQuery);
