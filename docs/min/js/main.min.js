...
!function(t){var n=1;t(".resume button").click(function(){t(".pane:nth-child("+ ++n+")").slideToggle(function(){t("html, body").animate({scrollTop:t(this).offset().top})})})}(jQuery);
!function(o){o(".work button").click(function(){o(".work__list").slideToggle(function(){o("html, body").animate({scrollTop:o(this).offset().top})})})}(jQuery);
