...
!function(n){n.expr[":"].onScreen=function(e){var o=n(window),t=o.scrollTop(),r=o.height(),i=t+r,c=n(e),f=c.offset().top+50,s=c.height(),l=f+s;return f>=t&&f<i||l>t&&l<=i||s>r&&f<=t&&l>=i},n(function(){setInterval(function(){n(".on-screen").filter(":onScreen").addClass("visible")},200)})}(jQuery);
