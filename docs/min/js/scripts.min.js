...
function startCountdownAndRedirect(){var n=document.getElementById("banner__countdown"),e=3;!function t(){n.textContent=e,--e<=0?window.location.href="https://www.youtube.com/playlist?list=PLBW-m5aC1WXYLfdPiV_auW6SUZ1D7hBUg":setTimeout(t,3e3)}()}location.pathname.includes("mtb")&&startCountdownAndRedirect();
