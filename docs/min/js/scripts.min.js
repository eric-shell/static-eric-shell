...
function startCountdownAndRedirect(){var t=document.getElementById("banner__countdown"),e=3;!function n(){t.textContent=e,--e<0?document.getElementById("banner__countdown").remove():setTimeout(n,3e3)}()}location.pathname.includes("mtb")&&startCountdownAndRedirect();
