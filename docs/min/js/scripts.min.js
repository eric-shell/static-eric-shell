...
$(function(){var n=1;$(".resume button").click(function(){$(this).hasClass("begin")&&$(".pane--intro").slideToggle(),n++,$(".pane:nth-child("+n+")").slideToggle(function(){var n=$(this).offset().top;$("html, body").animate({scrollTop:n})})})});
$(function(){$(".work__banner button").click(function(){$(".work__list, .work__banner").slideToggle();var o=$(this).offset().top;$("html, body").animate({scrollTop:o})})});
