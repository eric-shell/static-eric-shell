...
!function(e){e("span.next-pane").click(function(){e(this).closest(".pane").next(".pane").addClass("visible"),e("html,body").animate({scrollTop:e(this).closest(".pane").next(".pane").offset().top+100},350)})}(jQuery);
