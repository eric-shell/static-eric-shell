...
$(function(){$(".lazy").Lazy({effect:"fadeIn",effectTime:250,threshold:0,combined:!0,delay:7500})});
!function(e){e("span.next-pane").click(function(){e(this).closest(".pane").next(".pane").addClass("visible"),e("html,body").animate({scrollTop:e(this).closest(".pane").next(".pane").offset().top},250)})}(jQuery);