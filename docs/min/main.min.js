...
$(function(){$(".lazy").Lazy({effect:"fadeIn",effectTime:250,combined:!0,delay:7500})});
...
!function(o){o(".slogan a").mouseover(function(){o(".slogan").addClass("spread")}),o(".slogan a").mouseout(function(){o(".slogan").removeClass("spread")})}(jQuery);